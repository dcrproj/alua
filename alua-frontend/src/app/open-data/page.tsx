...
const datasetsJsonLd = {
  ...
  dataset: [
    { '@type': 'Dataset', name: 'Base Adresse Nationale (BAN)', description: 'Référentiel national de 25 millions d\'adresses françaises. Utilisé pour le géocodage, les fiches adresse et l\'autocomplétion de la barre de recherche.', url: 'https://adresse.data.gouv.fr', license: 'https://www.etalab.gouv.fr/licence-ouverte-open-licence', creator: { '@type': 'Organization', name: 'IGN / ANCT / La Poste' } },
    { '@type': 'Dataset', name: 'Plan Cadastral Informatisé (PCI)', description: 'Plan cadastral numérique couvrant 62 millions de parcelles françaises. Utilisé pour les fiches parcelle, les tuiles vectorielles cadastrales et les identifiants de parcelle.', url: 'https://www.data.gouv.fr/fr/datasets/plan-cadastral-informatise/', license: 'https://www.etalab.gouv.fr/licence-ouverte-open-licence', creator: { '@type': 'Organization', name: 'DGFiP / IGN' } },
    { '@type': 'Dataset', name: 'Demandes de Valeurs Foncières (DVF)', description: 'Historique de toutes les transactions immobilières en France depuis 2014. Utilisé pour les prix de vente, les prix médians et l\'évolution historique des prix au m².', url: 'https://www.data.gouv.fr/fr/datasets/demandes-de-valeurs-foncieres/', license: 'https://www.etalab.gouv.fr/licence-ouverte-open-licence', creator: { '@type': 'Organization', name: 'DGFiP' } },
    { '@type': 'Dataset', name: 'Diagnostics de Performance Énergétique (DPE)', description: 'Plusieurs millions de diagnostics énergétiques de logements français. Utilisé pour les étiquettes énergétiques sur les fiches parcelle et adresse, et la distribution DPE par commune.', url: 'https://data.ademe.fr/datasets/dpe-v2-logements-existants', license: 'https://www.etalab.gouv.fr/licence-ouverte-open-licence', creator: { '@type': 'Organization', name: 'ADEME' } },
    { '@type': 'Dataset', name: 'Géorisques', description: 'Données sur les risques naturels et technologiques couvrant la France entière. Utilisé pour la section Risques des fiches parcelle : PPRI, PPRN, PPRT, cavités, radon, séisme.', url: 'https://www.georisques.gouv.fr/api-georisques', license: 'https://www.etalab.gouv.fr/licence-ouverte-open-licence', creator: { '@type': 'Organization', name: 'BRGM / MTES' } },
    { '@type': 'Dataset', name: 'Base Nationale des Bâtiments (BDNB)', description: 'Référentiel de tous les bâtiments de France. Utilisé pour les caractéristiques du bâti sur la fiche parcelle : usage, année de construction, nombre de logements.', url: 'https://bdnb.io', license: 'https://www.etalab.gouv.fr/licence-ouverte-open-licence', creator: { '@type': 'Organization', name: 'CSTB / ADEME' } },
    { '@type': 'Dataset', name: 'SIRENE', description: 'Répertoire de tous les établissements actifs en France. Utilisé pour la section Entreprises des fiches parcelle : SIRET, raison sociale, code NAF.', url: 'https://www.sirene.fr', license: 'https://www.etalab.gouv.fr/licence-ouverte-open-licence', creator: { '@type': 'Organization', name: 'INSEE' } },
    { '@type': 'Dataset', name: 'Sitadel', description: 'Base de données des permis de construire en France depuis 2000. Utilisé pour la section Permis de construire des fiches parcelle : type, date, surfaces créées.', url: 'https://www.statistiques.developpement-durable.gouv.fr/catalogue?tag=Sitadel', license: 'https://www.etalab.gouv.fr/licence-ouverte-open-licence', creator: { '@type': 'Organization', name: 'SDES' } },
  ],
}
